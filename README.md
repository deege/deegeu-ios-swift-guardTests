...
The purpose of this repository is to supplement the video with code, and to provide a simple starting point for using guard statements in your app code.
